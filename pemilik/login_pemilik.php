              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-8">
                    <h4 class="mb-4 pb-4 mt-0 font-weight-bold">Login Pemilik Kos</h3></div>
                  </div>

                  <!-- Form -->
                  <form method="POST" action="login_proses_pemilik.php">
                    <div class="row">
                      <!-- Email Address -->
                      ...
                      <div class="input-group col-lg-12 mb-4">
                        ...
                        <input id="temail" type="email" name="temail" placeholder="Masukkan Alamat Email" class="form-control bg-white border-left-0 border-md">
                      </div>
                      ...
                      <!-- Link Daftar Sekarang-->
                        <div class="text-center w-100 mt-3">
                          <p class="font-weight-bold">Belum Punya Akun KONESA? <a href="daftar_pemilik.php" class="text-primary ml-2">Daftar Sekarang</a></p>
                        </div>
