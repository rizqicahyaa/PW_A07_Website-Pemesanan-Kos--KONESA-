              ...
              <div class="section-heading wow fadeInUp">
                <div class="row">
                  ...
                  <div class="input-group col-lg-2 mt-2">
                    ...
                    <img src="<?= $hasil['pemilik_gambar']; ?>" class="rounded-circle ml-3" style="width: 150px; height: 150px; object-fit:cover;">
                    </div>
                  </div>
                  <!-- Nama Lengkap -->
                  <div class="input-group col-lg-8 mt-2 mb-2">
                    ...
                    <div class="input-group col-sm-6 mt-4">
                      <h5 class="font-weight-bold"><?php echo $hasil['pemilik_nama'] ?></h5>
                    </div>
                    <!-- Tanggal Lahir -->
                    <div class="input-group col-sm-6 mt-4">
                    ...
                    <div class="input-group col-sm-6 mt-4">
                      <h5 class="font-weight-bold"><?php echo $hasil['pemilik_tanggal_lahir'] ?></h5>
                    </div>
                      <!-- Jenis Kelamin -->
                      <div class="input-group col-sm-6 mt-4">
                      ...
                      <div class="input-group col-sm-6 mt-4">
                        <h5 class="font-weight-bold"><?php echo $hasil['pemilik_gender'] ?></h5>
                      </div>
                      <!-- Email -->
                      <div class="input-group col-sm-6 mt-4">
                      ...
                      <div class="input-group col-sm-6 mt-4">
                        <h5 class="font-weight-bold"><?php echo $hasil['pemilik_email'] ?></h5>
                      </div>
                      <!-- No.Hp -->
                      <div class="input-group col-sm-6 mt-4">
                      ...
                      <div class="input-group col-sm-6 mt-4">
                        <h5 class="font-weight-bold"><?php echo $hasil['pemilik_telp'] ?></h5>
                      </div>     
                  </div>
            ...
            <div class="col-12">
              <div class="section-heading wow fadeInUp">
                <div class="row">
                  ...
                  <img src="<?= $hasil['pemilik_foto_identitas']; ?>" class="ml-3" style="width: 150px; height: 150px; object-fit:cover;">
                  </div>
                </div>
                <div class="input-group col-lg-6 justify-content-sm-end">
                  ...
                  <div class="input-group col-sm-12 mt-2">
                    <h5 class="font-weight-bold"><?php echo $hasil['pemilik_jenis_identitas'] ?></h5>
                  </div>
