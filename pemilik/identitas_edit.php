        ...
        <div class="row">
          <div class="col-12">
            <div class="section-heading wow fadeInUp">
              <form method="POST" action="identitas_edit_proses.php" enctype="multipart/form-data" name="form_pemilik">
                ...
                <div class="row">
                  ...
                  <div class="input-group col-lg-12 mb-4">
                    ...
                    <div class="input-group">
                      ...
                      <img src="<?php echo $data['pemilik_foto_identitas']; ?>" width="200px;" id="fotoid">
                      </div>
                      <div class="input-group">
                  ...
                  <div class="input-group col-lg-6 mt-4 mb-4">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control bg-white border-left-0 border-md validate-input h-100" id="jenisid" name="jenisid" required="required">
                          <option value="KTP" <?php if ($data['pemilik_jenis_identitas']=='KTP') echo "selected";
                              ?>>KTP</option>  
                          <option value="SIM" <?php if ($data['pemilik_jenis_identitas']=='SIM') echo "selected";
                              ?>>SIM</option>
                          <option value="PASSPORT" <?php if ($data['pemilik_jenis_identitas']=='PASSPORT') echo "selected";
                              ?>>PASSPORT</option>
                        </select>
                    </div>
                  </div>
