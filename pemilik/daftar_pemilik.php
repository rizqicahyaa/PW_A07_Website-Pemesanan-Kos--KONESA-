        ...
        <div class="row py-2 align-items-center">
            ...
            <div class="col-md-7 col-lg-6 ml-auto mb-4">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-2"><a href="login_pemilik.php"><i class="fa fa-circle-chevron-left"></i></a></div>
                    <div class="col-10">
                    <h4 class="mb-4 pb-4 mt-0 font-weight-bold text-center">Daftar Akun Pemilik Kos</h3></div>
                  </div>

                  <!-- Form -->
                  <form method="POST" action="daftar_proses_pemilik.php" enctype="multipart/form-data">
                    <div class="row">
                      <!--foto profil-->
                    ...
                    <div class="input-group">
                      ...
                      <!-- Link Daftar Sekarang-->
                        <div class="text-center w-100 mt-3">
                          <p class="font-weight-bold">Sudah Punya Akun KONESA? <a href="login_pemilik.php" class="text-primary ml-2">Login Disini</a></p>
                        </div>
