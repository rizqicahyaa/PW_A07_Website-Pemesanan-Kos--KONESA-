        ...
        <div class="row">
          <div class="col-12">
            <div class="section-heading wow fadeInUp">
              <form method="POST" action="data_edit_proses.php" enctype="multipart/form-data" name="form_pencari">
                ...
                <div class="row">
                  ...
                  <div class="input-group col-lg-12 mb-4">
                    ...
                    <div class="input-group">
                      ...
                      <img src="<?php echo $data['pencari_gambar']; ?>" width="200px;" id="fotoprofil">
                      </div>
                      <div class="input-group">
                  ...
                  <div class="input-group col-lg-6 mt-4">
                    ...
                    <div class="input-group">
                      ...
                      <input id="tnama" type="text" name="tnama" class="form-control bg-white border-left-0 border-md validate-input h-100" value="<?php echo $data['pencari_nama']; ?>" required="required">
                    </div>
                  </div>
                  <!-- tgl lahir -->
                  <div class="input-group col-lg-6 mt-4">
                    ...
                    <div class="input-group">
                      ...
                      <input id="tgllahir" type="date" name="tgllahir" class="form-control bg-white border-left-0 border-md validate-input h-100" value="<?php echo $data['pencari_tanggal_lahir']; ?>" required="required">
                    </div>
                  </div>
                  <!-- Jenis Kelamin -->
                  <div class="input-group col-lg-6 mt-4">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control bg-white border-left-0 border-md validate-input h-100" id="gender" name="gender" required="required">
                          <option value="L" <?php if ($data['pencari_gender']=='L') echo "selected";
                              ?>>Laki-laki</option>  
                          <option value="P" <?php if ($data['pencari_gender']=='P') echo "selected";
                              ?>>Perempuan</option>
                        </select>
                    </div>
                  </div>
                  ...
                  <div class="input-group col-lg-6 mt-4">
                    ...
                    <div class="input-group">
                      ...
                      <input id="temail" type="email" name="temail" class="form-control bg-white border-left-0 border-md validate-input h-100" value="<?php echo $data['pencari_email']; ?>" required="required">
                    </div>
                  </div>
                  <!--No.Hp-->
                  <div class="form-group col-lg-6 mt-4">
                        ...
                        <div class="input-group">
                          ...
                          <input id="ttelp" type="telp" name="ttelp" placeholder="Masukkan No.Hp" class="form-control bg-white border-left-0 border-md validate-input h-100" onkeypress="return Angkasaja(event)" value="<?php echo $data['pencari_telp']; ?>" required="required">
                        </div>
                      </div>
                  <!-- Submit Button -->
