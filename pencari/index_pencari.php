          ...
          <div class="col-12 col-md-6 col-xl-4 mt-4">
            ...
            >
              ...
              <div class="property-thumb">
                <img src="../pemilik/<?php echo $hasil['kos_gambar']; ?>" style="width: 400px; height: 300px; object-fit:cover;" alt="kamar"/>
              ...
              <div class="property-content">
                ...
                <span class="font-weight-bold"><?php echo $hasil['kos_gender']; ?></span>
                ...
                <div
                  class="property-meta-data d-flex align-items-end justify-content-end"
                >
                <div class="mt-4" style="float:right;">
                    <a href="detail_kos.php?kos_id=<?=$hasil['kos_id']?>" class="btn btn-primary" >Lihat Detail</a>
                </div>
                </div>
              </div>
            </div>
