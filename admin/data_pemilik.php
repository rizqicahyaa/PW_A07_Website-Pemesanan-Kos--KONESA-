                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                        <?php 
                                                        $que = $kon->kueri("SELECT * FROM pemilik_kos");
                                                        $no = 1;
                                                        ...
                                                        if($jumlah == 0) {
                                                            ...
                                                            echo "<td>$data[pemilik_tanggal_lahir]</td>";
                                                            echo "<td>$data[pemilik_gender]</td>";
                                                            echo "<td>$data[pemilik_email]</td>";
                                                            echo "<td>$data[pemilik_telp]</td>";
                                                            echo "<td><img src='../pemilik/".$data['pemilik_gambar']."' width='70' /></td>";
                                                            echo "<td>$data[pemilik_jenis_identitas]</td>";
                                                            echo "<td><img src='../pemilik/".$data['pemilik_foto_identitas']."' width='70' /></td>";
                                                            echo "<td><a href='#' class='btn-small btn-outline-danger' onclick=\"javascript: if(confirm('Apakah ".addslashes($data['pemilik_nama'])." mau dihapus?')==true)
                                                            {window.location.href='data_pemilik_proses.php?aksi=hapus&tid=$data[pemilik_id]'; } \"><i class='fas fa-fw fa-trash'></i><span>Hapus</span></a></td>";
                                                            echo "</tr>";
                                                            $no++;
                                                            }
                                                        }
