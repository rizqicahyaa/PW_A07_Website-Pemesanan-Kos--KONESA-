                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                            <?php 
                                                        $que = $kon->kueri("SELECT * FROM pencari_kos");
                                                        $no = 1;
                                                        ...
                                                        if($jumlah == 0) {
                                                            ...
                                                            echo "<td>$data[pencari_tanggal_lahir]</td>";
                                                            echo "<td>$data[pencari_gender]</td>";
                                                            echo "<td>$data[pencari_email]</td>";
                                                            echo "<td>$data[pencari_telp]</td>";
                                                            echo "<td><img src='../pencari/".$data['pencari_gambar']."' width='70' /></td>";
                                                            echo "<td>$data[pencari_jenis_identitas]</td>";
                                                            echo "<td><img src='../pencari/".$data['pencari_foto_identitas']."' width='70' /></td>";
                                                            echo "<td><a href='#' class='btn-small btn-outline-danger' onclick=\"javascript: if(confirm('Apakah ".addslashes($data['pencari_nama'])." mau dihapus?')==true)
                                                            {window.location.href='data_pencari_proses.php?aksi=hapus&tid=$data[pencari_id]'; } \"><i class='fas fa-fw fa-trash'></i><span>Hapus</span></a></td>";
                                                            echo "</tr>";
                                                            $no++;
                                                            }
                                                        }
