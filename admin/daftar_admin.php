              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-10">
                    <h4 class="mb-4 pb-4 mt-0 font-weight-bold text-center">Daftar Akun admin</h3></div>
                  </div>

                  <!-- Form -->
                  <form method="POST" action="daftar_proses_admin.php" enctype="multipart/form-data">
                  <div class="row">
                      <!--foto profil-->
                  ...
                  <div class="form-group col-lg-12">
                      ...
                      <!-- Link Daftar Sekarang-->
                        <div class="text-center w-100 mt-3">
                          <p class="font-weight-bold">Sudah Punya Akun KONESA? <a href="login_admin.php" class="text-primary ml-2">Login Disini</a></p>
                        </div>
