                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                            <?php 
                                                                $que = $kon->kueri("SELECT a.kos_id, a.kos_nama, a.kos_alamat, a.kos_tipe, a.kos_fasilitas, a.kos_lokasi, a.kos_gender, a.kos_jarak, a.kos_harga , a.status,  a.kos_gambar, b.pemilik_id , b.pemilik_id, b.pemilik_nama FROM data_kos a JOIN pemilik_kos b ON a.pemilik_id = b.pemilik_id");
                                                                $no = 1;
                                                                ...
                                                                if($jumlah == 0) {
                                                                    ...
                                                                    echo "<td><a href='#' class='btn-small btn-outline-danger' onclick=\"javascript: if(confirm('Apakah ".addslashes($data['kos_nama'])." mau dihapus?')==true)
                                                                    {window.location.href='isi_kos_proses.php?aksi=hapus&tid=$data[kos_id]'; } \"><i class='fas fa-fw fa-trash'></i><span>Hapus</span></a></td>";
                                                                    echo "</tr>";
                                                                    $no++;
                                                                    }
                                                                }
